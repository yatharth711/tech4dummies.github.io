        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="https://forms.gle/mV49WR6AQBqFVgQB6">Feedback</a></li>
                <li class="active"><a href="us.php">About Us</a></li>
                <li class="active"><a href="upload.php">Contribute!</a></li>
                <H1></H1>
              </ul>
          ...
          <div class ="container">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  <img src="./content/s1.png" alt="internet">
                  <div class="caption">
                    <h3>Software</h3>
                    <p>Here we learn about the software and tools with it </p>
                    <p><a href="sw1.php" class="btn btn-primary" role="button">Let's Go</a></p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  <img src="./content/h.png" alt="internet">
                  <div class="caption">
                    <h3>Hardware</h3>
                    <p>We learn about the physical components of Computer  </p>
                    <p><a href="hw1.php" class="btn btn-primary" role="button">Let's Go</a></p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  <img src="./content/cd.png" alt="internet">
                  <div class="caption">
                    <h3>Coding</h3>
                    <p>We learn the basic coding in HTML and Javascript </p>
                    <p><a href="cd1.php" class="btn btn-primary" role="button">Let's Go</a></p>
                  </div>
                </div>
              </div>
            </div>
...
<hr>
            <footer class="footer" >
            <div class="container">
              <p style="text-align:center;"><strong> <h3>If you are intrested in adding a course to this site click <a  href="upload.php">here.</a></h3></strong></p>

          <pre>This is a website under the Creative Comments Copyright. All rights are reserved for Tech4Dummies©.  </pre>
